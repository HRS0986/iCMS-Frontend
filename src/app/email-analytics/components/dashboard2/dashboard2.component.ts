...
export class Dashboard2Component implements OnInit{
  ...
  isLoadingBestProduct:boolean = false
  isLoadingWorstProduct:boolean = false
  
  bestEmail!: string
  bestEmailColor:string = 'var(--indigo-400)'
  isLoadingBestPerfEmail:boolean = false
